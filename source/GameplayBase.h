...
public:
    GameplayBase() = default;
    virtual ~GameplayBase() = default;
...
inline void GameplayBase::OnEnter()
{
...
inline void GameplayBase::OnExit()
{
    _player = nullptr;
...
inline void GameplayBase::Update(float dt)
{
    if (_background != nullptr)
...
inline void GameplayBase::Render()
{
    if (_background != nullptr)
        _background->Render();
...
inline void GameplayBase::CheckBossConditions(float dt)
{
...
inline bool GameplayBase::IsBossFullyVisible()
{
    if (_boss != nullptr)
    {
...
inline void GameplayBase::CreateHUD()
{
...
inline void GameplayBase::UpdateHUD()
{
    if (_player == nullptr)
        return;
...
inline void GameplayBase::HandleBulletUpdates(float dt)
{
...
inline void GameplayBase::HandlePowerUpUpdates(float dt)
{
...
inline void GameplayBase::HandleEnemyUpdates(float dt)
{
...
inline void GameplayBase::HandleCollisions()
{
    for (Enemy* enemy : _enemies)
    {
        if (enemy->IsPendingDestroy())
...
inline void GameplayBase::HandlePlayerDeath()
{
...
inline void GameplayBase::SpawnPowerUp(Vector2 position)
{
...
inline void GameplayBase::ApplyPowerUpToPlayer(PowerUpType type)
{
    if (_player == nullptr)
        return;
